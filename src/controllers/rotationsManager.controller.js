...
export const updateSingleData = async (req, res) => {
  ...
  const {totalsc} = req.body;
  const {totalgr} = req.body;
  ...
  console.log("TOTALSCHEMA = "+ totalsc);
  console.log("TOTALGRUPO = "+ totalgr);
...
//Actualizar el fijo de un usuario
export const updateTurnoFijo = async (req, res) => {
  const { idUs } = req.params;
  ...
  console.log("IDUSER = "+ idUs);
  console.log("FIJO = "+ req.body.fijo);
...
//Actualizar el fijo de un usuario
export const updatePostDel = async (req, res) => {
  const { id } = req.params;
...
export const updateName = async (req, res) => {
  const { id_esquema } = req.body;
  const { nuevonombre } = req.body;

  console.log("ID PARA CTUALIZAR NOMBRE = "+ id_esquema);
  ...
  try {
    ...
    res.json({
      message: `error intentando actualizar la información con id de esquema ${id_esquema}`,
    });
  }
};
...
export const deleteUserBalancerById = async (req, res) => {
...
export const updateTotalSchema = async (req, res) => {
  ...
  console.log("TOTALSCHEMAS = "+ total);
...
export const updateTotalGroup = async (req, res) => {
  ...
  try {
    await RotationManager.updateMany({groupId:id},{$set:{totalGrupo:nuevovalor}}); 
    res.json({ message: "Operacion realizada" });
  } catch (error) {
    res.json({
      message: `error intentando actualizar la información con id  ${id}`,
